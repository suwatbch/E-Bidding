...
export default function LanguageSwitcher({ variant = 'login' }: LanguageSwitcherProps) {
  ...
  const buttonStyles = {
    login: "group flex items-center gap-1.5 px-2 py-1.5 text-gray-700 hover:text-blue-600 text-sm transition-all duration-300",
    navbar: "group flex items-center justify-between gap-1.5 px-4 py-2.5 rounded-lg text-sm transition-all duration-300 md:text-white md:hover:bg-white/10 text-gray-700 hover:bg-blue-50/50 w-full md:w-auto"
  };
