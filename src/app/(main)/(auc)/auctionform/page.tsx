          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  <div className="flex items-center gap-2">
                    <AucHourglassIcon className="w-4 h-4 text-gray-500" />
                    สถานะ
                  </div>
                </label>
                <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  <div className="flex items-center gap-2">
                    <AucCurrencyIcon className="w-4 h-4 text-gray-500" />
                    หน่วยเงิน
                  </div>
                </label>
                <div className="relative">
            ...
            <div className="space-y-4">
              ...
              <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <p className="text-xs text-yellow-700 mt-1">
                  • 1 คน เข้าร่วมได้เพียง 1 บริษัท • 1 บริษัท มีตัวแทนได้เพียง 1
                  คน
                </p>
              </div>
                      ...
                      <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                        {getFilteredCompanies().length > 0 ? (
                          getFilteredCompanies().map((company) => {
                            const hasParticipant = selectedParticipants.some(
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (
                        ...
                        // ตรวจสอบอีกครั้งว่าบริษัทสุดท้ายที่จะใช้ยังไม่มีในรายการ
                        if (
                          selectedParticipants.some(
                            (p) => p.company_id === finalCompanyId
                          )
                        ) {
                          alert(
                            'บริษัทนี้มีผู้เข้าร่วมประมูลแล้ว กรุณาเลือกบริษัทอื่น'
                          );
                          return;
                        }
